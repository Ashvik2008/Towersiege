...
function preload(){
backgroundImg1 = loadImage("light.jpg");
backgroundImg2 = loadImage("dark.jpg");
...
function setup() {
  ...
  ground2= new Ground(500,400,230,10);
  ground3= new Ground(1200,230,150,10);
  ...
  block17= new Block(1150,128,25,35);
  block18= new Block(1175,128,25,35);
  block19= new Block(1200,128,25,35);
  block20= new Block(1225,128,25,35);
  block21= new Block(1250,128,25,35);

  block22= new Block(1175,93,25,35);
  block23= new Block(1200,93,25,35);
  block24= new Block(1225,93,25,35);

  block25= new Block(1200,58,25,35);

  square=new Square(150,350,45);
  drag= new Drager(square.body,{x:150,y:400});
}
...
function draw() {
 ...
 textSize(19);
 fill(255)
 text("Drag the hexagonal stone and launch it towards the blocks",10,20);

 textSize(19);
 fill(255)
 text("Press 'space' to get another turn",10,40);
